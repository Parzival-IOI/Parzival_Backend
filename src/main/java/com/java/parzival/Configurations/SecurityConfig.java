package com.java.parzival.Configurations;


import com.java.parzival.Services.UserImplementService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/authenticate/refreshToken").hasRole("REFRESH_TOKEN")
